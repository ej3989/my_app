#!/usr/bin/env python3
"""LAN-only MCUboot OTA helper for the Pico 2 W fan controller."""
...
# The library logs the full binary request on a timeout. This tool reports
# concise retry and final errors itself.
...
async def upload_with_retries(args: argparse.Namespace) -> None:
    ...
    for attempt in range(1, args.retries + 2):
        try:
            # A new connection prevents a delayed response from an earlier
            # attempt from being mistaken for the new SMP sequence.
